  ...
  return (
    <div>
        <nav className="bg-white dark:bg-gray-800  shadow ">
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="block">
                        <div className="ml-4 flex items-center md:ml-6">
                            <a href="https://github.com/yellodot" className="p-1 rounded-full text-gray-400 focus:outline-none hover:text-gray-200">
                            ...
                            <div className="ml-3 relative">
                                <div className="relative inline-block text-left">
                                    <div>
                                        <button type="button" className="flex items-center justify-center w-full rounded-md  px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-50 hover:bg-gray-50 dark:hover:bg-gray-500 focus:outline-none  focus:ring-offset-gray-100 focus:ring-gray-500">
                    ...
                    <div className="burger-button mr-2 flex md:hidden">
                        <button 
            ...
            {
                toggled ? 
                <div className="mobile-menu transition ease-in-out delay-200 md:hidden">
